      ...
      <el-col :span="6">
        <el-card>
          ...
          <Detail title="总销售额" count="$126560">
            ...
            <template slot="footer"> 日销售额$12345 </template>
          </Detail>
        </el-card>
      </el-col>
      <el-col :span="6">
        <el-card>
          ...
          <Detail title="访问量" count="88460">
            ...
            <template slot="footer"> 日销访问量 1234 </template>
          </Detail>
        </el-card>
      </el-col>
      <el-col :span="6">
        <el-card>
          ...
          <Detail title="支付笔数" count="88460">
            ...
            <template slot="footer"> 转化率 64% </template>
          </Detail>
        </el-card>
      </el-col>
      <el-col :span="6">
...
import paogressCharts from "./progressCharts";
export default {
  name: "",
  data() {
    return {};
  },
  components: { Detail, lineCharts, barCharts, paogressCharts },
  methods: {},
};
</script>
